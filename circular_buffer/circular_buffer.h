...
__attribute__((always_inline)) static inline int32_t get_from_buffer(CircularBuffer* buffer, size_t index) {
    return buffer->data[index];
}
__attribute__((always_inline)) static inline void set_to_buffer(CircularBuffer* buffer, size_t index, int32_t value) {
