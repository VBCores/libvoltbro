...
enum class AS5047PParams: uint16_t {
    // Registers
    REG_DIAG_AGC = 0x3FFC,
    REG_MAGNITUDE = 0x3FFD,
    REG_ANGLE = 0x3FFF,
...
class AS5047P: public ASxxxx<AS5047PParams> {
public:
    AS5047P(
        GpioPin&& spi_ss,
        ...
        std::forward<GpioPin>(spi_ss), spi, 16384, is_inverted, electric_offset
    ) {};
};
